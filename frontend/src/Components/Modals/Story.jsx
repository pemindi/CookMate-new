...
const Story = () => {
  ...
  return (
    ...
    >
      {/* Background elements matching CreateStoryModal */}
      ...
      <div className="modal-title">
        <h2 className="modal-title-text">
          {userId === Story.userId ? "Edit Story" : "View Story"}
        </h2>
        ...
        <div className="story-view-container">
          ...
          <div className="story-details">
            <div className="story-author-info">
              ...
              />
              <span className="story-author-name">{author?.name || "Unknown"}</span>
            </div>
            <h3>{Story?.title}</h3>
  ...
  return (
    <Modal
      ...
      footer={
        userId === Story.userId
          ...
          : [
              <Button key="close" onClick={handleCancel} className="modal-close-btn">
                Close
              </Button>
            ]
      }
    ...
    >
      {userId !== Story.userId ? (
        ...
        <Form form={form} layout="vertical" className="story-edit-form">
          ...
          <Form.Item label="Image" name="image">
            <Upload
              ...
              disabled={imageUploading}
            >
              <Button icon={<UploadOutlined />} disabled={imageUploading} className="upload-button">
