...
const CreatePostModal = () => {
  ...
  return (
    <Modal
      ...
      title={
        <div className="modal-title">
          <span className="modal-title-text">Create New Post</span>
    ...
    >
      ...
      <Form form={form} layout="vertical" onFinish={handleSubmit} className="create-post-form">
        <Form.Item
          name="contentDescription"
          label={<span className="form-label">Share your thoughts</span>}
          rules={[
        ...
        {imageUploading ? (
          <div className="uploading-indicator">
            ...
            <p>Media is uploading, please wait...</p>
          </div>
        ) : (
          <Form.Item
            name="mediaLink"
            label={<span className="form-label">Add Media</span>}
        ...
        {fileType === "image" && image && (
          <div className="media-preview image-preview">
            <FileImageOutlined className="media-type-icon" />
            <img
              src={image}
              alt="preview"
        ...
        {fileType === "video" && image && (
          <div className="media-preview video-preview">
            <VideoCameraOutlined className="media-type-icon" />
            <video
              controls
              src={image}
